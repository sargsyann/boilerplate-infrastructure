...
module "this" {
  ...
  application_dashboard = {"data_source":{"type":"prometheus"},"rows":[{"name":"backend-strapi","type":"block/service"},{"name":"frontend","type":"block/service"}],"variables":[{"name":"namespace","options":[{"selected":true,"value":"prod"},{"value":"demo"}]}]}
