...
module "this" {
  ...
  map_roles = [{"groups":["system:masters"],"rolearn":"arn:aws:iam::091947912116:role/aws-reserved/sso.amazonaws.com/eu-central-1/AWSReservedSSO_AdministratorAccess_ab82266ca76b72c5","username":"AWSReservedSSO_AdministratorAccess_ab82266ca76b72c5"}]
